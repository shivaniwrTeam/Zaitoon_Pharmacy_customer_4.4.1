              ...
              child: AlertDialog(
                ...
                content: Column(
                  ...
                  children: [
                    ...
                    if (pincodeLoading) const Center(
                            child: Padding(
                              ...
                              child: SingleChildScrollView(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    if (pincodeSearchList.isNotEmpty) Column(
                                            crossAxisAlignment:
                                                CrossAxisAlignment.start,
                                            children: getPincodeList(setStater),) else Padding(
                                            padding: const EdgeInsets.symmetric(
                                                vertical: 20.0,),
            ...
            return AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  ...
                  if (cityLoading) const Center(
                          child: Padding(
                            padding: EdgeInsets.symmetric(vertical: 50.0),
                            child: CircularProgressIndicator(),
                          ),
                        ) else (citySearchLIst.isNotEmpty)
                          ? Flexible(
                              child: SizedBox(
                                height:
