...
class StateProfile extends State<MyProfile> with TickerProviderStateMixin {
  ...
  _getDrawer() {
    return ListView(
      ...
      children: <Widget>[
        if (context.read<UserProvider>().userId == "") const SizedBox.shrink() else _getDrawerItem(getTranslated(context, 'MY_ORDERS_LBL')!,
                'assets/images/pro_myorder.svg',),
        if (context.read<UserProvider>().userId == "") const SizedBox.shrink() else _getDrawerItem(getTranslated(context, 'MANAGE_ADD_LBL')!,
                'assets/images/pro_address.svg',),
        if (context.read<UserProvider>().userId == "") const SizedBox.shrink() else _getDrawerItem(getTranslated(context, 'MYWALLET')!,
                'assets/images/pro_wh.svg',),
        if (context.read<UserProvider>().userId == "") const SizedBox.shrink() else _getDrawerItem(getTranslated(context, 'YOUR_PROM_CO')!,
        ...
        if (context.read<UserProvider>().userId == "" || !refer) const SizedBox.shrink() else _getDrawerItem(getTranslated(context, 'REFEREARN')!,
        ...
        if (context.read<UserProvider>().userId == '') const SizedBox() else _getDrawerItem(
