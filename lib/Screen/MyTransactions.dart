              ...
              child: Column(
                  ...
                  children: <Widget>[
                    ...
                    if (tranList[index].type != null &&
                            tranList[index].type!.isNotEmpty) Text(
                            "${getTranslated(context, 'PAYMENT_METHOD_LBL')!} : ${tranList[index].type!}",) else const SizedBox.shrink(),
                    Padding(
                      padding: const EdgeInsets.symmetric(vertical: 4.0),
                    ...
                    if (tranList[index].txnID != null &&
                            tranList[index].txnID!.isNotEmpty) Text(
                            "${getTranslated(context, 'Txn_id')!} : ${tranList[index].txnID!}",) else const SizedBox.shrink(),
                  ],),),),
    );
  }
